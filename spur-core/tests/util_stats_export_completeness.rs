...
fn steer_authority(m: &mut Marks) -> SteerAuthorityStats {
    SteerAuthorityStats {
        ...
        source_bound_sessions: m.int(),
        source_unbound_sessions: m.int(),
        honored: m.int(),
...
fn steer_authority_leaves(prefix: &str, b: &SteerAuthorityStats) -> Vec<(String, Value)> {
    ...
    vec![
        ...
        leaf(prefix, "source_bound_sessions", *source_bound_sessions),
        leaf(prefix, "source_unbound_sessions", *source_unbound_sessions),
