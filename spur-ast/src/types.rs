...
use crate::name::{BuiltinFn, NameId};
use crate::span::Span;
...
pub enum TypedExprKind {
    ...
    VariantLit(NameId, NameId, String, Option<Box<TypedExpr>>),
    ...
    FieldAccess(Box<TypedExpr>, NameId, String),

    SafeFieldAccess(Box<TypedExpr>, NameId, String),
    SafeIndex(Box<TypedExpr>, Box<TypedExpr>),
    SafeTupleAccess(Box<TypedExpr>, usize),

    StructLit(NameId, Vec<(NameId, String, TypedExpr)>),
...
pub enum TypedPatternKind {
    ...
    Variant(NameId, NameId, String, Option<Box<TypedPattern>>),
    Error,
}
...
pub struct TypedProgram {
    ...
    /// Struct definitions: NameId → list of (field_id, field_name, field_type)
    pub struct_defs: HashMap<NameId, Vec<(NameId, String, Type)>>,
    /// Enum definitions: NameId → list of (variant_id, variant_name, optional payload_type)
